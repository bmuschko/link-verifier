...
func init() {
	...
	rootCmd.PersistentFlags().StringSliceVar(&parsedOptions.IncludePatterns, "includes", []string{"*.md", "*.adoc"}, "comma-separated root directories used to recursively search for files")
