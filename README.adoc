...
- `includePatterns`: The comma-separated include patterns used to search for files. Defaults to common AsciiDoc, Markdown and plain-test file extensions. The value of the include patterns are always additive to the default file patterns.
